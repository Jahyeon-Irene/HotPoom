    ...
    <div id="paymentInformationWrap">
        ...
        <div id="receiptAccountSelectInner">
            ...
            <div id="receiptAccountDetailBox" class="receipt_account_detail">
                ...
                <form method="POST" action="/user/account/${userAccount.no}/${user.no}">
...
<script>
    ...
    $("#nameUpdateCompleteBtn").on("click",function(){
    	...
    	$.ajax({
    		url:"/ajax/updateName/${user.no}/"+name,
    		type:"PUT",
    		datatype:"json",
    		error:function(){
    			alert("서버 점검중!");
...
//     });//keyup end
    ...
    $("#phoneNumUpdateCompleteBtn").on("click",function(){
    	...
    	$.ajax({
    		url:"/ajax/updatePhoneNum/${user.no}/"+phoneNum,
    		type:"PUT",
    		datatype:"json",
    		error:function(){
    			alert("서버 점검중!");
